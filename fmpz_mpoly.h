...
FLINT_DLL void fmpz_mpoly_set_monomial_ui(fmpz_t new_exp, const ulong * exp, const fmpz_mpoly_ctx_t ctx);
...
FLINT_DLL slong _fmpz_mpoly_mul_johnson_new(fmpz ** poly1, fmpz ** exp1, slong * alloc,
...
FLINT_DLL slong _fmpz_mpoly_divrem_monagan_pearce(slong * lenr,
  fmpz ** polyq, fmpz ** expq, slong * allocq, fmpz ** polyr,
                  fmpz ** expr, slong * allocr, const fmpz * poly2,
   const fmpz * exp2, slong len2, const fmpz * poly3, const fmpz * exp3, slong len3);
...
FLINT_DLL int _fmpz_mpoly_gcd_threaded_pool(fmpz_mpoly_t G,
       const fmpz_mpoly_t A, const fmpz_mpoly_t B, const fmpz_mpoly_ctx_t ctx,
                        const thread_pool_handle * handles, slong num_handles);
